...
void espkk()
{
    ...
    ImGui::Begin("espkk", &espkkkk, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoBackground);
    {
        ...
        ImGui::GetForegroundDrawList()->AddText(tab_text, 16, ImVec2(110 + p.x, 762 + p.y), ImColor(255, 255, 255, 255), "nox:lowkey.net");
...
int main(int, char**)
{
    ...
    ::RegisterClassExW(&wc);
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"ImGui DirectX11 Example", WS_OVERLAPPEDWINDOW, 100, 100, 1280, 800, nullptr, nullptr, wc.hInstance, nullptr);
    ...
    while (!done)
    {
        ...
        ImGui::NewFrame();
        {
            ...
            ImGui::Begin("Menu", &menu, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoBackground);
            {
                ...
                {
                    ImGui::GetForegroundDrawList()->AddText(tab_text3, 20 * dpi_scale, ImVec2(20 * dpi_scale + p.x, 12 * dpi_scale + p.y), ImColor(255, 255, 255, 255), "Menu");
             ...
             //   ImGui::GetWindowDrawList()->AddRectFilled(ImVec2(0 + p.x, 0 + p.y), ImVec2(705 + p.x, 60 + p.y), ImGui::GetColorU32(colors::lite_color), s.WindowRounding);
                ...
                ImGui::GetForegroundDrawList()->AddText(tab_text3, 16 * dpi_scale, ImVec2(10 * dpi_scale + p.x, 765 * dpi_scale + p.y), ImColor(255, 255, 255, 255), "Uid:nox");
                ...
                ImGui::BeginChild("General", ImVec2(717 * dpi_scale, 720 * dpi_scale), false);
                {
                    ...
                    case 0:
                    {
                        ...
                        ImGui::BeginChildPos("Misc", ImVec2(300 * dpi_scale, 580 * dpi_scale));
                        {
                            ...
                            for (int i = 0; i < 40; i++)
                            {
                                ImGui::Text("test:UI BY:nox", checboxes);
                            }
                        }
                        ImGui::EndChild();
