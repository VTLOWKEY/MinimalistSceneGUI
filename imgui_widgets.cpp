...
inline ImVec4 main_color(218, 96, 21, 255);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.gradient_color0 = ImLerp(it_anim->second.gradient_color0, *v ? checkbox_gradient_start : hovered ? ImVec4(0, 0, 0, 0) : ImVec4(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.gradient_color1 = ImLerp(it_anim->second.gradient_color1, *v ? checkbox_gradient_end : hovered ? ImVec4(0, 0, 0, 0) : ImVec4(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
    it_anim->second.checkmark_color = ImLerp(it_anim->second.checkmark_color, *v ? checkbox_mark : hovered ? ImVec4(0, 0, 0, 0) : ImVec4(0, 0, 0, 0), g.IO.DeltaTime * 9.f);
